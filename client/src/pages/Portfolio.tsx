    ...
    <div className="space-y-6">
      ...
      <div className="bg-black border border-zinc-800 rounded-xl p-4 text-center">
        <div className="flex items-center justify-center gap-1 mb-1">
          ...
          <h2 className="text-base font-semibold">Total Portfolio Value</h2>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-black border border-zinc-800 rounded-xl p-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-zinc-400 text-xs">Unrealized P&L</span>
          </div>
          <p className={`text-base font-bold ${(unrealizedProfit || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="bg-black border border-zinc-800 rounded-xl p-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-zinc-400 text-xs">Realized P&L</span>
          </div>
          <p className={`text-base font-bold ${(realizedProfit || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
      ...
      <div className="bg-black border border-zinc-800 rounded-xl p-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-zinc-800/50 rounded-lg p-3 text-center">
            ...
            <p className="text-zinc-400 text-xs">Cash Balance</p>
            <p className="text-base font-bold">{formatInrWithNA(currentBalances?.inr || 0)}</p>
          </div>
          <div className="bg-zinc-800/50 rounded-lg p-3 text-center">
            <Bitcoin className="w-5 h-5 text-white mx-auto mb-1" />
            <p className="text-zinc-400 text-xs">Bitcoin</p>
            <p className="text-base font-bold">{formatCurrency(currentBalances?.btc || 0, 'BTC')}</p>
      ...
      <div className="bg-black border border-zinc-800 rounded-xl p-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-zinc-800/50 rounded-lg p-3 text-center">
            <span className="text-zinc-400 text-xs">Borrowed Amount</span>
            <p className="text-base font-bold">{formatInrWithNA(loanSummary?.borrowedAmount || 0)}</p>
          </div>
          <div className="bg-zinc-800/50 rounded-lg p-3 text-center">
            <span className="text-zinc-400 text-xs">Interest Accrued</span>
            <p className="text-base font-bold">{formatInrWithNA(loanSummary?.interestAccrued || 0)}</p>
          </div>
          <div className="bg-zinc-800/50 rounded-lg p-3 text-center">
            <Bitcoin className="w-5 h-5 text-white mx-auto mb-1" />
            <span className="text-zinc-400 text-xs">Collateral Bitcoin</span>
            <p className="text-base font-bold">{formatCurrency(loanSummary?.collateralBtc || 0, 'BTC')}</p>
          </div>
        </div>
      </div>
      ...
      {/* Trading Metrics */}
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <Target className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">Avg Buy Price</p>
        ...
        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          ...
          <p className="text-zinc-400 text-xs">Breakeven Price</p>
          <p className="text-base font-bold">
      ...
      {bitcoinData && (
        <>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-base font-semibold">Bitcoin Market Overview</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-black border border-zinc-800 rounded-xl p-3">
              ...
              <p className="text-base font-bold">{formatLargeNumber(bitcoinData?.market_cap_usd)}</p>
            </div>
            ...
            <div className="bg-black border border-zinc-800 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-zinc-400 text-xs">24h Volume</span>
              </div>
              <p className="text-base font-bold">{formatLargeNumber(bitcoinData?.volume_24h_usd)}</p>
            </div>
          </div>
      ...
      {bitcoinData && (
        <>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-base font-semibold">All-Time High</h3>
          </div>

          <div className="bg-black border border-zinc-800 rounded-xl p-3 mb-4">
            <div className="grid grid-cols-3 gap-3">
              <div>
                <p className="text-zinc-500 text-xs mb-1">Price</p>
                <p className="text-sm font-bold">${(bitcoinData?.ath_usd || 0).toLocaleString()}</p>
              </div>
              <div>
                <p className="text-zinc-500 text-xs mb-1">Date</p>
                <p className="text-sm font-bold">{bitcoinData?.ath_date ? formatDate(bitcoinData.ath_date) : 'N/A'}</p>
              </div>
              <div>
                <p className="text-zinc-500 text-xs mb-1">From ATH</p>
                <p className={`text-sm font-bold ${(bitcoinData?.ath_change_pct || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <div className="text-base font-bold mb-2">{sentimentData?.fear_greed_value || 0}/100</div>
            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className={`text-base font-bold ${getSentimentColor(sentimentData?.fear_greed_classification || 'Neutral')}`}>
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-base font-semibold">Trading Statistics</h3>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          ...
          <p className="text-zinc-400 text-xs">Trading Days</p>
          <p className="text-base font-bold">{tradingStats?.tradingDays || 0}</p>
        </div>

        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <BarChart3 className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">Total Trades</p>
          <p className="text-base font-bold">{tradingStats?.totalTrades || 0}</p>
        </div>

        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <Clock className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">This Month</p>
          <p className="text-base font-bold">{tradingStats?.tradesThisMonth || 0}</p>
        </div>

        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <DollarSign className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">Avg Trade Size</p>
          <p className="text-base font-bold">{formatInrWithNA(tradingStats?.averageTradeSize || 0)}</p>
        </div>

        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <TrendingUp className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">Total Volume</p>
          <p className="text-base font-bold">{formatInrWithNA(tradingStats?.totalVolume || 0)}</p>
        </div>

        <div className="bg-black border border-zinc-800 rounded-xl p-3 text-center">
          <Trophy className="w-5 h-5 text-white mx-auto mb-1" />
          <p className="text-zinc-400 text-xs">Days in Profit</p>
          <p className="text-base font-bold">
      ...
      <div className="bg-black border border-zinc-800 rounded-xl p-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-zinc-400 text-xs">Current Market Rates</span>
        </div>
